      ...
      : "text-[hsl(var(--ff-dark))]"
       ...
       >
        {category}
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-4 sm:gap-6 md:gap-8 text-[hsl(var(--ff-dark))]">
            {categories.map((category) => (
              <button
                key={category}
                onClick={() => setActiveCategory(category)}
                className={`text-sm sm:text-base md:text-lg font-medium transition-all 
                  ...
                  ${activeCategory === category
                    ? "border-2 border-white text-white bg-transparent"
                    : "text-[hsl(var(--ff-dark))] bg-[hsl(var(--ff-yellow))]/10 hover:bg-[hsl(var(--ff-yellow))]/20"
                  }`}
              >
                {category}
              </button>
